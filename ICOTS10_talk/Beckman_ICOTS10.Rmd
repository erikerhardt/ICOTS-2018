...
- Sample
    ...
    - Data analysis is based on a representative random sample of 178 responses including students from all 16 participating classes.
- ISTUDIO assessment tool
    - 7 open-ended tasks, each with two or more parts
    - Statistical inference is appropriate for some, but not all questions.
